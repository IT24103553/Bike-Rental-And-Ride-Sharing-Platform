...
<section id="hero" class="relative bg-cover bg-center bg-no-repeat text-white">
  ...
  <div class="container mx-auto px-6 relative z-10 flex flex-col items-center justify-center min-h-[600px] text-center">
    <div class="max-w-3xl">
      ...
      <a href="#" class="hero-cta">Book a Ride</a>
    </div>
  </div>
</section>
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
      ...
      <div class="p-4 flex flex-col flex-grow">
        ...
        <a href="#" class="bg-[#f76b64] text-white px-4 py-2 rounded-lg mt-4 font-bold hover:bg-[#fa8a76] transition text-center">Rent Now</a>
      </div>
    </div>
    <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col">
      <div class="h-60 overflow-hidden">
