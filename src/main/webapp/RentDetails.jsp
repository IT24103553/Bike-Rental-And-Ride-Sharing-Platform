  ...
  <div class="overflow-x-auto">
    <table class="custom-table w-full">
      ...
      <tr>
        ...
        <td>
          <a href="UpdateRentalRequest.jsp?orderNumber=<%= URLEncoder.encode(rental[2], StandardCharsets.UTF_8) %>" class="btn btn-primary btn-custom text-white mr-2">Update</a>
